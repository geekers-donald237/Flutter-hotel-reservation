...
import '../screens/hotel/search/room/roomDetails.dart';
...
class PlaceWidget extends StatelessWidget {
  ...
  const PlaceWidget({ Key? key , this.item, this.animation, this.animationController,required this.hotel,required this.destination_1}) : super(key: key);
              ...
              child: GestureDetector(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => RoomDetails(hotel: hotel, destination_1: destination_1, room: item!,),
                    ),
                  );
                },
                child: Container(
